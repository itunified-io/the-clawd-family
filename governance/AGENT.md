...
1. On every commit to `governance/AGENT.md`, a GitHub Action triggers re-ingest
...
|------|-----------|------------|---------------|------------|
| the-clawd-family | `tcf-governance` | `governance/AGENT.md`, `governance/JIRA.md`, `governance/RELEASE.md` | DOCUMENTATION | `comp:tcf-governance` |
...
- Example output:
  ...
  governance/AGENT.md          @itunified-io/ai-documentation
...
Template files are provided in `templates/workflows/` in the central governance
repository and must be adapted per project (replace `<PROJECT_KEY>` with the
actual Jira project key).
...
> Templates: `templates/workflows/` in the central governance repo
